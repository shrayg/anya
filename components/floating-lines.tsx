...
// Vendored from React Bits Floating Lines
// https://reactbits.dev/backgrounds/floating-lines
// Source: github.com/DavidHDev/react-bits — TS + three.js shader.
...
/* Anya ice-blue fallbacks (not React Bits default purple/pink). */
const vec3 PINK  = vec3(195.0, 211.0, 230.0) / 255.0;
const vec3 BLUE  = vec3(120.0, 148.0, 180.0) / 255.0;
...
export type FloatingLinesProps = {
  ...
  /** Pause RAF when the canvas is offscreen or the tab is hidden. */
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Cap DPR like other site WebGL backgrounds.
    ...
    const syncRAF = () => {
      if (onScreen && tabVisible) startRAF();
      else stopRAF();
    };
