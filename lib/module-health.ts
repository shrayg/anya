...
export const MODULE_HEALTH_RULES: Record<string, ModuleHealthRule> = {
  ...
  steam: { kind: "any", providers: ["godseye", "breachvip", "csint"] },
  xbox: { kind: "off" },
  playstation: { kind: "off" },
  telegram: { kind: "any", providers: ["godseye", "csint"] },
  instagram: { kind: "any", providers: ["instagram", "godseye"] },
  snapchat: { kind: "any", providers: ["godseye", "csint"] },
  tiktok: { kind: "any", providers: ["godseye", "csint"] },
  "tiktok-recon": { kind: "any", providers: ["csint"] },
  "share-resolver": { kind: "any", providers: ["csint"] },
  twitter: { kind: "any", providers: ["godseye", "csint"] },
  reddit: { kind: "any", providers: ["godseye", "csint"] },
  github: { kind: "any", providers: ["godseye", "csint"] },
