...
export const US_STATE_PORTALS: StatePortalDef[] = [
  ...
  { state: "DE", name: "Delaware", courtUrl: "https://courtconnect.courts.delaware.gov/", courtLabel: "Delaware CourtConnect", sorUrl: "https://sexoffender.dsp.delaware.gov/", liveCourtAdapter: true },
  ...
  { state: "FL", name: "Florida", courtUrl: "https://www.flcourts.gov/Florida-Courts/Trial-Courts", courtLabel: "Florida trial courts (county portals)", sorUrl: "https://offender.fdle.state.fl.us/offender/sops/home.jsf", liveCourtAdapter: true, liveSorAdapter: true },
  ...
  { state: "IN", name: "Indiana", courtUrl: "https://public.courts.in.gov/", courtLabel: "Indiana courts", sorUrl: "https://www.icrimewatch.net/indiana.php", liveCourtAdapter: true },
  ...
  { state: "MD", name: "Maryland", courtUrl: "https://casesearch.mdcourts.gov/casesearch/", courtLabel: "Maryland Case Search", sorUrl: "https://www.dpscs.state.md.us/onlineservs/sor/" },
  ...
  { state: "NY", name: "New York", courtUrl: "https://iapps.courts.state.ny.us/webcivil/FCASMain", courtLabel: "New York WebCivil Supreme", sorUrl: "https://www.criminaljustice.ny.gov/Soms/" },
  ...
  { state: "OK", name: "Oklahoma", courtUrl: "https://www.oscn.net/dockets/search.aspx", courtLabel: "Oklahoma OSCN", sorUrl: "https://sors.doc.ok.gov/", liveCourtAdapter: true },
  ...
  { state: "PA", name: "Pennsylvania", courtUrl: "https://ujsportal.pacourts.us/", courtLabel: "Pennsylvania UJS Portal", sorUrl: "https://www.pameganslaw.state.pa.us/", liveCourtAdapter: true },
  ...
  { state: "TX", name: "Texas", courtUrl: "https://research.txcourts.gov/", courtLabel: "re:SearchTX", sorUrl: "https://publicsite.dps.texas.gov/SexOffenderRegistry" },
  ...
  { state: "WA", name: "Washington", courtUrl: "https://odysseyportal.courts.wa.gov/ODYPortal", courtLabel: "Washington Odyssey Portal", sorUrl: "https://www.waspc.org/sex-offender-information/" },
  ...
  { state: "WI", name: "Wisconsin", courtUrl: "https://wcca.wicourts.gov/", courtLabel: "Wisconsin CCAP", sorUrl: "https://www.wi-doc.com/offender.htm", liveCourtAdapter: true },
