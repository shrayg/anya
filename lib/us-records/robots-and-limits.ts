...
export const SOURCE_LIMITS = {
  ...
  "wa-doh-license": { timeoutMs: 15_000, ttlMs: 12 * 60 * 60 * 1000 },
  "calbar-license": { timeoutMs: 25_000, ttlMs: 12 * 60 * 60 * 1000 },
  "tx-tdlr": { timeoutMs: 25_000, ttlMs: 12 * 60 * 60 * 1000 },
  "dea-fugitives": { timeoutMs: 20_000, ttlMs: 6 * 60 * 60 * 1000 },
  "faa-aircraft": { timeoutMs: 20_000, ttlMs: 6 * 60 * 60 * 1000 },
  "fcc-uls": { timeoutMs: 25_000, ttlMs: 6 * 60 * 60 * 1000 },
  "uspto-ptab": { timeoutMs: 20_000, ttlMs: 12 * 60 * 60 * 1000 },
  "nc-doc": { timeoutMs: 25_000, ttlMs: 6 * 60 * 60 * 1000 },
  "il-doc": { timeoutMs: 25_000, ttlMs: 6 * 60 * 60 * 1000 },
  "usms-wanted": { timeoutMs: 20_000, ttlMs: 6 * 60 * 60 * 1000 },
