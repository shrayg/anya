  ...
  },
  {
    ...
    items: [
      ...
      mod(
        ...
        "court-records",
        "us-court",
        "John Doe, VA — or a federal docket number",
        "Federal RECAP dockets, live Virginia OCIS, and state court portal routing when a US state is specified.",
        undefined,
        undefined,
        { lawfulUseNotice: true },
      ),
      mod(
        ...
        "Compose FEC, NPI, OFAC, UN sanctions, FBI/Interpol wanted, NSOPW, and court indexes.",
        undefined,
        undefined,
        { lawfulUseNotice: true },
      ),
      ...
      mod(
        ...
        "us-wanted",
        "First and last name",
        "FBI wanted posters and Interpol Red Notice public index.",
        undefined,
        undefined,
        { lawfulUseNotice: true },
      ),
