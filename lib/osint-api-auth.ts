...
export function resolveOsintModuleSlug(
  ...
  const defaults: Record<string, string> = {
    ...
    "nosint/ip": "ip",
    datavoid: "breaches",
    "datavoid/recovery": "breaches",
    "datavoid/us": "breaches",
    "datavoid/ca": "breaches",
    "datavoid/il": "breaches",
    "datavoid/stealer": "stealer-logs",
    "datavoid/automotive": "vin-decoder",
    "datavoid/automotive/check": "vin-decoder",
    "datavoid/company": "breaches",
    ...
    "hudsonrock/search-by-domain": "domains",
    "hudsonrock/search-by-domain/overview": "domains",
    "hudsonrock/search-by-domain/assessment": "domains",
    "hudsonrock/search-by-domain/discovery": "domains",
    "hudsonrock/search-by-login/emails": "stealer-logs",
    "hudsonrock/search-by-login/usernames": "stealer-logs",
    "hudsonrock/search-by-ip": "ip",
    ...
    "oathnet/extract-subdomain": "domains",
    "oathnet/victims": "stealer-logs",
    "oathnet/discord-to-roblox": "oathnet-roblox",
