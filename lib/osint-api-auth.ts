...
export function resolveOsintModuleSlug(
  ...
  const defaults: Record<string, string> = {
    ...
    // Dedicated OathNet module (Ultimate+) — /api/oathnet also forceModuleSlug.
    "oathnet/breach": "oathnet",
    "oathnet/stealer": "oathnet",
    "oathnet/stealer-subdomain": "oathnet",
    "oathnet/extract-subdomain": "oathnet",
    "oathnet/victims": "oathnet",
    "oathnet/discord-to-roblox": "oathnet",
    "oathnet/discord-userinfo": "oathnet",
    "oathnet/discord-username-history": "oathnet",
    "oathnet/steam": "oathnet",
    "oathnet/xbox": "oathnet",
    "oathnet/roblox-userinfo": "oathnet",
    "oathnet/mc-history": "oathnet",
    "oathnet/ip-info": "oathnet",
    "oathnet/holehe": "oathnet",
    "oathnet/ghunt": "oathnet",
    oathnet: "oathnet",
    telegram: "telegram",
