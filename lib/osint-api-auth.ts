...
export function resolveOsintModuleSlug(
  ...
  const defaults: Record<string, string> = {
    ...
    // OathNet endpoints — map to category modules for scope hints.
    // Dedicated `/api/oathnet/*` still forceModuleSlug: "oathnet" (Ultimate+).
    ...
    "oathnet/ip-info": "ip",
    "oathnet/holehe": "username",
    "oathnet/ghunt": "username",
    oathnet: "oathnet",
    telegram: "telegram",
